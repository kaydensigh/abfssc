if(typeof gRMd!=='undefined'){
  ...
  var cB\XFrf=((cBXNoR)?cBXFxf:cBXRf.fillColor);
  if(gDFK){
    cBXf.delay=true;
  ...
  if(cBXvm.length>0){
    ...
    if(cBXvm.length>4){
      if(cBXvm.substr(-3,2)==='!#'){
        ...
        v\ar cBXcx='0123456789BPWTXxbygupo'.indexOf(cBXqc);
        if(cBXcx>=0){
...
if(cBXvm.length>0){
              ...
              if(cBXzsvals.length>0){
                ...
                if(cBXthisi<0){
                  ...
                  if(cBXucd>10000){
                    ...
                    cBXthisi+=1;
                    cBXzsvals=cBXzsvals.substring(cB\Xthisi);
                    while(cBXzsvals.length>0){
                      ...
                      if(cBXzsxy>=0){
                        ...
                        cBXzsxy='ABCDEFGHIJKLMNOPQRSTUV\WXYZ'.indexOf(cBXzsxc);
                        if(cBXzsxy>=0){
                ...
                if(cBXv.length>3){
                  if(cBXpc==='U'){
                    if(cBXv.charAt(0)==='+'){
                      ...
                      if(cBXhxw){
                        cBXst\r+=String.fromCharCode(parseInt(cBXhxw[1],16));
                        cBXucd=0;
                        ...
                        cBXhxi+=4){
                          ...
                          if(cBXhxv.match(gHXf)){
                            cBXstr+=String.fromCharCod\e(parseInt(cBXhxv,16));
                            cBXhxc+=4;
                            cBXucd=0;
                          }
                          else{
              ...
              if(cBXpj<3){
                ...
                if(cBXpj<17){
                  ...
                  if(cBXpj==0){
                    ...
                    cBXstr+=' ext:'+this.external+' fV:'+app.formsVersion+' vV:'+app.viewerVersion+' Vt:'+app.viewerType+' Vv:'+app.viewerVariation+' o:'+app.platform+' gRMo='+gRM\o+' R:'+gRevC+' bT:'+gBldT+' ';
                  }
                }
                else if(cBXpj<49){
                  cBXstr+=cBXbg;
  ...
  if(cBXmd<=5){
    ...
    if(cBXmd>=2){
            ...
            if(cBXv.length-1==cBXbfp){
              ...
              if(cBXbfpj>=0){
                if(cBXbfpj<4){
                  ...
                  if(cBXbfpc==='%')cBXstr+=gBFA[0+cBXbfbd+\cBXbfit];
                }
              }
              else{
                cBXbfg=false;
                ...
                e\lse if(cBXbfpc==='X'){
                  ...
                  if(cBXv.length>3){
                    if(cBXv.charAt(0)==='+'){
                      ...
                      if(cBXbfxw){
                        cBXstr+\=String.fromCharCode(parseInt(cBXbfxw[1],16));
                        cBXbfu=0;
                        ...
                        cBXbfi+=4){
                          ...
                          if(cBXbfxv.match(gHXf)){
                            cBXstr+=String.fromCharC\ode(parseInt(cBXbfxv,16));
                            cBXbfc+=4;
                            cBXbfu=0;
                          }
                          else{
                  ...
                  cBXstr+=' ext:'+this.external+' fV:'+app.formsVersion+' vV:'+app.view\erVersion+' Vt:'+app.viewerType+' Vv:'+app.viewerVariation+' o:'+app.platform+' gRMo='+gRMo+' R:'+gRevC+' bT:'+gBldT;
                }
              }
            }
          }
      ...
      var cBXBf=cBXdf;
      if(cBXBf.textSize!==cBXbftz)cBXBf.text\Size=cBXbftz;
...
if(cBXmd<2){
  if(cBXNoR){
    ...
    if(cBXvf.richText)cBXvf.richText=\false;
    cBXvf.value=cBXv;
  }
}
else if(cBXisR){
...
if(cBXNoR){
  ...
  if(cBXvf==cBXRf){
    ...
    if(cBXR\f.display!==display.noView)cBXRf.display=display.noView;
...
if(event.commitKey==3){
  if(gSPNs==2){
    var cBXfcf=null;
    if(gOzX.i\ndexOf(' NoTabOut')<0)cBXfcf=this.getField('T_TWO');
    console.println('TabOut '+event.targetName+' cK:'+event.commitKey+((event.willCommit)?' wC':'')+((cBXfcf==null)?'':' >>T_TWO'));
    gFaA(0,1,'TAB TAB TAB','You have TABbed out of field '+even\t.targetName+'\r \rPlease see bookmark [Help / General / Tab Sequence]');
