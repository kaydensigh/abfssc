if(typeof gLgE==='undefined') {
  function gLgE(kAXr,kAXo) {
    ...
    if(event.type!=='Field')kAXm+=' '+event.type;
    kAXm+=' '+event.name;
    ...
    if(event.target.charLimit!==0)kAXm+=' L:'+event.target.charLimit;
    if(event.value) {
      ...
      if(event.value!==event.target.valueAsString)kAXm+=' v>'+event.target.valueAsString+'<';
    }
...
if(typeof gMRFL==='undefined') {
  function gMRFL(jAXo) {
        ...
        if(jAXL>0) {
          ...
          if(jAXjA.length==2) {
            ...
            jAXy++) {
              ...
              var jAXONM=jAXnm.substr(0,jAXix)+jAXrcO+jAXnm.substr(jAXiz);
              if(jAXONM!==jAXnm) {
                gARFE(jAXONM,jAXnm);
                jAXx++;
              }
    ...
    if(gVrbL>0)console.println('@'+util.printd('HH:MM:ss ',new Date())+'Made RF lists. NumF='+this.numFields+gRFCt());
    return;
  }
}
...
if(typeof gFsRFs==='undefined') {
  function gFsRFs() {
    ...
    if(pAXza<5) {
      ...
      var pAXi=pAXj-pAXza;
      var pAXu=pAXza-5;
      if(pAXi>0)pAXmw+='\r  and '+pAXu+' others,  with '+pAXi+' empty.\r ';
    }
    var pAXat=2;
    if(pAXmw.length>0) {
    ...
    if(pAXr==3)console.println('All retired field non-empty values:\r'+pAXvA.join('\r')+'\r ');
    pAXmw='';
    pAXvA=[];
  }
}
  ...
  function gFSD() {
    if(this.numFields>0) {
      ...
      if(app.viewerVersion<6.0) {
        if(typeof(app.viewerVariation)!=='undefined') {
    ...
    if(lAXrr!=null) {
      ...
      lAXji++) {
        ...
        if((typeof(lAXqf)!=='undefined')&&(lAXqf!==null)) {
          lAXstr=lAXstr.replace(lAXqnz,lAXqf.valueAsString);
        }
        else {
          var lAXst='undefined';
          if(lAXqn.indexOf('.')<0) {
          ...
          switch(lAXst) {
            ...
            break;
            case 'object':var lAXyt='var lAXsv='+lAXqn+';var lAXsvl='+lAXqn+'.length;';
            eval(lAXyt);
            lAXstr=lAXstr.replace(lAXqnz,lAXsv);
            break;
            ...
            if(gVrbL>4)console.println('--'+lAXqn+' is not defined');
            break;
...
if(typeof gFDC==='undefined') {
  function gFDC(xAXo) {
    console.println('Start Vu Codes, VC is '+gVCds+' >0, o='+xAXo+' Vm='+gVmD+' > 0');
    gVCds=0;
    gVmD=0;
    if(gThRm) {
    ...
    xAXi<xAXiL;
    xAXi++) {
      var xAXn=this.getNthFieldName(xAXi);
      if(gThRm) {
        xAXTn++;
        if(xAXTz--<=0) {
    ...
    gVCds=1;
    if(gThRm) {
      if(xAXTm.cancelled)console.println('Thermometer was cancelled.');
      xAXTm.end();
    }
  }
}
        ...
        while(kBXi>=0) {
          ...
          if(kBXj>=0) {
            ...
            if(kBXk<0) {
              ...
              if(kBXL.indexOf(' ')>=0)console.println('ODD HELP key?:'+kBXL+':');
...
if(typeof gFCX==='undefined') {
  function gFCX(qBXRoL) {
    ...
    if(qBXopt>0) {
      ...
      qBXci<qBXnumF;
      qBXci++) {
        var qBXfn=this.getNthFieldName(qBXci);
        ...
        if(qBXtk==3) {
          ...
          if(qBXf.display==display.visible)qBXDv++;
        ...
        if(qBXtk<0) {
          ...
          if(typeof(gCXH[qBXz])==='undefined')gCXH[qBXz]=0;
          gCXH[qBXz]++;
          continue;
        }
        if(qBXtk<3) {
          ...
          if(qBXf.display==display.noPrint)qBXTnP++;
      ...
      if(qBXopt>7) {
        ...
        for(var qBXk in gCXH) {
          if(gCXH[qBXk]>0)qBXm+=' '+qBXk+':'+gCXH[qBXk];
        }
        qBXm+=' .';
    ...
    if(qBXrfrsh>0) {
      ...
      if(gTfXR)qBXxrm+='\r   Due to suspected bug in Foxit, you really should do so.';
      ...
      var qBXansAr=new Array('00','OK','Cancel','No','Yes','5','6');
      ...
      if(qBXgh==1) {
        if(qBXrs>15) {
          ...
          gFiF('+*FixUpALL');
          if(gVrbL>2)console.println('..after REFRESH..  Rv:'+gCXH['Rv']+' Tf:'+gCXH['Tf']+' =>'+qBXrs);
          qBXrs+=128;
        }
      }
    }
...
if(typeof gFOP==='undefined') {
  function gFOP(pBXRoL) {
    var pBXvl=pBXRoL;
    var pBXof=this.getField('My_Options');
    if(pBXof!=null) {
      ...
      pBXoi++) {
        ...
        if(pBXoh=='PULnn') {
          ...
          do {
            ...
            if(pBXoe>=0)pBXov=pBXov.substr(0,pBXoe)+pBXov.substr(pBXoh.length+pBXoe);
          }
          while(pBXoe>=0);
        }
      ...
      if(pBXPi>0) {
        ...
        if(gPUpL!=5)console.println('_PopupL='+gPUpL);
      }
    ...
    if(typeof(app.runtimeHighlight)==='boolean') {
      ...
      if(app.runtimeHighlight!=lBXnfx) {
        ...
        if(lBXRoLA<4)app.alert( {
          nIcon:0,nType:0,cMsg:'Runtime field highlighting has been '+((app.runtimeHighlight)?'enabled':'disabled')+'.\r \rSee bookmark HELP / BLUE Fill for more details.'
        });
      }
    }
    else {
  ...
  function gFsTc(xBXRoL) {
    if(typeof(gScHash)=='undefined') {
      ...
      xBXi++) {
        ...
        var xBXq='S'+xBXc;
        if(typeof(gScHash[xBXq])!=='undefined') {
...
if(typeof gRpR==='undefined') {
  function gRpR(kCXc,kCXmin) {
    if(gVrbL>0) {
      ...
      if(kCXwq>kCXmin) {
        console.println('T.Vv '+'Pending Rectangles.'+kCXc+': '+kCXwq);
      }
    }
    if(gVrbL>2) {
  ...
  function gRadR(jCXv) {
    ...
    if(jCXi>=0) {
      ...
      if(gTfXR) {
        ...
        var jCXf=this.getField('My_Rectangles');
        if(jCXf!==null) {
...
if(typeof gRdNA==='undefined') {
  ...
  if(typeof gFHsR==='undefined') {
    function gFHsR() {
      ...
      lCXyi++) {
        ...
        if((lCXwn.substr(0,2)!=='V_')&&(lCXwn.substr(0,2)!=='v_'))continue;
      ...
      if(xCXopt>7) {
        ...
        if(!event.shift) {
          if(xCXt==null) {
            ...
            var xCXttl='Rich Text FOCUS Warning..';
            ...
            xCXmsg+='\r \rTo bypass this message, press <Shift> when clicking in the rectangle.';
  ...
  if(typeof gFMjW==='undefined') {
    function gFMjW() {
      ...
      if(kDXjf!=null) {
        ...
        var kDXm='We currently will '+((kDXov.indexOf(' HideJ')<0)?'expose':'hide')+' the java warning message when we save the form.\r \rClick <YES> to '+((kDXov.indexOf(' HideJ')<0)?'hide':'expose')+' the message when we save the form,\r  or  <NO>  to proceed to the next question,\r  or <CANCEL> to do nothing more here.';
        kDXr=gFaA(3,2,kDXh,kDXm);
        if(kDXr==4) {
          var kDXz='-';
  ...
  if(typeof gTRaO==='undefined') {
    function gTRaO() {
      ...
      var jDXr=gFaA(3,2,'Adjust Refresh at Open','This is primarily used in Adobe PDF reader products.\r \rYou can change the automatic refresh via page swapping\rduring the openUp process\r \rCurrent setting = '+jDXmm+'\r \r Click <Yes> to ENABLE \r   <No>  to  DISABLE\r <Cancel> for no change.');
      if(jDXr==4)gFOP(':+RfrAtOp:');
    ...
    function gFsH(qDXRoL) {
      if(this.numFields>0) {
        ...
        if(qDXm.length<4) {
          ...
          if(qDXm.length<4)qDXm='Sorry, text for <HELPTAG> is unavailable.<n>  <n>It may be loaded to a HELP field via an FDF file.<n> <n>For more details<n> please consult the usage guide for at least revision 19F04 of this form.';
  ...
  if(typeof gFSz==='undefined') {
    function gFSz(tDXRoL) {
      if(this.numFields>0) {
        ...
        var tDXf=this.getField('My_FormatA');
  ...
  if(typeof gFUp==='undefined') {
    function gFUp(lDXRoL) {
      ...
      lDXt++) {
        ...
        var lDXtk='T|>RLyzBQxKvwoiSjV'.indexOf(lDXtu);
        if(lDXtk>4)continue;
        var lDXg=0;
  ...
  if(typeof gFbR==='undefined') {
    function gFbR(xDXRoL) {
      if(this.numFields>0) {
        var xDXMR=this.getField('My_Richness');
        var xDXFn='AskRb';
        if(xDXRoL==='Rich') {
          var xDXgh=gFaA(0,2,'Need NONE before Rich','This will be a bit slow.\r \rWe need to set mode NONE before RICH mode\r i.e. there will be 2 refresh cycles\r \rThe screen may not refresh until this completes.');
  ...
  if(typeof gFVbR==='undefined') {
    function gFVbR(kEXRoL) {
      ...
      kEXv=kEXv.replace('!6',' 6=CERULEAN ');
  ...
  if(typeof gFmkR==='undefined') {
    function gFmkR(jEXRoL) {
      ...
      if(jEXf==null) {
        ...
        console.println('No need to Make field '+jEXn);
      }
      if(jEXf!=null) {
  ...
  if(typeof gFARd==='undefined') {
    function gFARd(qEXRoL) {
      ...
      qEXi++) {
        ...
        if(qEXtk>2)continue;
        var qEXrfn='D_'+qEXfn;
        if(this.getField(qEXrfn)!=null)continue;
        qEXnA.push(qEXfn);
      }
      var qEXx=0;
      while(qEXnA.length>0) {
        ...
        if(qEXrf==null) {
          console.println('..Failed to create D_ field for '+qEXn);
          gFHash[qEXn]='W';
        }
        else {
    ...
    function gFDRd(pEXRoL) {
      ...
      while(pEXnA.length>0) {
        ...
        try {
          ...
          console.println('E_DelR '+pEXn+' : '+e.message);
        }
  ...
  if(typeof gRMU==='undefined') {
    function gRMU() {
      ...
      if(tEXf==null) {
        ...
        var tEXtgt=null;
        if(gSPNs==2) {
          if(gVrbL>0)console.println('D_Mu: '+tEXRn+' m:'+event.modifier+' s:'+event.shift);
          tEXtgt=tEXf;
          tEXn=8;
        }
        else if (gSPNs==1) {
        ...
        if(tEXtgt!==null) {
          ...
          if(tEXn==8) {
            if(tEXRf.display!==display.noView)tEXRf.display=display.noView;
          }
          tEXtgt.setFocus();
        }
      }
  ...
  if(typeof gFpC==='undefined') {
    function gFpC() {
      if(this.numPages<2)app.alert( {
        cTitle:'System Card PDF Form',nIcon:3,nType:0,cMsg:' \rWho stole some page(s)?\r \rRemoving pages may cause problems with this form.\r \rPlease check the Usage Guide for more details.'
      });
    }
  }
    ...
    function gFFz() {
      if(gIzC==0) {
        if(gOzX.indexOf('FSZnoLim')<0) {
          ...
          if(this.filesize>xEXzL)app.alert( {
            cTitle:'System Card PDF Form',nIcon:3,nType:0,cMsg:' \rThis file looks very big.   '+this.filesize+' exceeds '+xEXzL+'\r \rPlease consider using the [REFRESH] bookmark to perform a FULL refresh.\r \rTHEN use SAVE_AS new file name when saving the file.\r \rYour program may need optimize functions enabled.\r \rAlso check the Usage Guide for more details.'
          });
        }
      }
    }
  ...
  if(typeof gFcF==='undefined') {
    function gFcF(kFXRoL) {
      if(typeof(gFontA)=='undefined') {
        console.println('..JB: gFcF is missing gFontA');
      }
      else {
  ...
  if(typeof gFPuM==='undefined') {
    function gFPuM() {
      ...
      if(gTMF<1)qFXc='TINY';
      if(gTMF>1)qFXc='LONG';
      var qFXqA=gFaA(3,2,'Popup Messages','We normally show long popup messages in multiple shorter messages.\rLong messages can cause the <OK> button to be off-screen and seem inaccessible.\rIf that happens you should press <Enter> or the spacebar to close the message and avoid losing any changes you had made to the form.\r \rClick  <Yes>  for LONG messages,  <No>  for SHORT messages\r  or  <Cancel>  for TINY messages.    Current = '+qFXc+'\r \rA good bookmark to test this on is [Rich Codes]');
      if(qFXqA==4)gTMF=2;
      if(qFXqA==3)gTMF=1;
      if(qFXqA==2)gTMF=0;
      ...
      if(gWHt>410) {
        if(gTMF<2) {
          console.println('BOOST popup height selection one level!');
          gTMF++;
        }
      }
    }
  ...
  if(typeof gFCkF==='undefined') {
    function gFCkF() {
      if(this.numFields>0) {
        ...
        if(gRMo>=8) {
          tFXcmg='Rich Text is available with this program.\r \rFor rich enabled fields using codes : the current font';
          if(gFontA.length>1) {
        ...
        app.alert('There are no fields in this file - it looks FLATtened/signed.\r \r...Most bookmarks will now do nothing.');
      }
    }
  }
  ...
  if(typeof gFxDS==='undefined') {
    function gFxDS() {
      ...
      if(xFXf!=null) {
        console.println('..finally, HIDE the javascript warning  D:'+this.dirty);
      ...
      this.dirty=xFXtdty;
      if(this.dirty)console.println('DS.Note: STILL dirty');
      var xFXpzL=12;
      if(gTfXR)xFXpzL=6;
      if(gPUpL>xFXpzL) {
        ...
        gFaA(0,3,'Saved','Save has finished'+xFXmm+'.\r \rUsage Guide has more details.');
      }
    }
  }
  if(typeof gFxWS==='undefined') {
    function gFxWS() {
      ...
      if(this.numFields>0) {
        ...
        var kMXzL=((gSPNs==2)?1810000:1550000);
        if(this.filesize>kMXzL)gFaA(0,3,'Reminder','The form is getting large.  size '+this.filesize+' exceeds '+kMXzL+'\r \rYou should occasionally use SAVE_AS a new file name to optimize the contents.\r \rYour program may need optimize functions enabled.');
        var kMXrs=gFCX(13);
        if(kMXrs>127)gFCX(3);
        for(var kMXi=0;
        kMXi<this.numFields;
        ...
        console.println('WILL SAVE.. '+this.numFields+' fields: '+kMXn+' rich, '+kMXm+' required, text fields');
  ...
  if(typeof gFxDP==='undefined') {
    function gFxDP() {
      if(typeof(gWPd)=='undefined') {
        console.println('..JB: gFxDP is missing gWPd');
      }
      else {
